...
├── dhcp_spoofing_v3.py                            ← Script del ataque
├── images/
│   ├── imagen_01_topologia.png
│   ├── imagen_02_servidor_dhcp_falso_iniciado.png
│   ├── imagen_03_victima_ip_envenenada.png
│   ├── imagen_04_intercambio_dhcp_completo.png
│   └── imagen_05_contramedida_dhcp_snooping.png
└── video/
    └── dhcp_spoofing_demo.mp4                     ← Video de demostración (máx. 5 min)
```
